...
# Define paths
base_image_dir = '/content/drive/MyDrive/split_19/img'
base_annotation_dir = '/content/drive/MyDrive/split_19/ann'
meta_file_path = '/content/drive/MyDrive/Edi 7th sem/Concrete Stru/meta.json'
model_save_path = '/content/drive/MyDrive/Edi 7th sem/Concrete Stru/ssd_model_trained_Concrete_FF_F_f_f_N.pth'
pretrained_model_path = '/content/drive/MyDrive/ssd_model_trained_Concrete_FF_F_M.pth'
...
def train_on_all_splits():
    ...
    print(f"Training on split: split_3")
